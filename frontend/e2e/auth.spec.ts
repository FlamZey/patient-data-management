...
test.describe("authentication", () => {
  ...
  // Already being logged in and visiting the login page bounces straight to home instead of showing the form again.
  test("already being logged in and visiting login bounces straight to home", async ({ page }) => {
    await login(page);
